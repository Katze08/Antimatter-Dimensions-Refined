...
export default {
  ...
  methods: {
    ...
    update() {
      ...
      this.score = Decimal.multiply(multipliers.am, Decimal.multiply(multipliers.ip, Decimal.multiply(multipliers.ep, Decimal.multiply(multipliers.rm, /*multipliers.sim*/ new Decimal(1)))));
      player.gears.score.mantissa = this.score.mantissa;
      player.gears.score.exponent = this.score.exponent;
...
<template>
  <div>
    ...
    <h3>All autobuyer intervals are divided by the gear score.</h3>
  </div>
</template>
