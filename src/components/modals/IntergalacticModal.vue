...
import { becomeIntergalactic } from "@/game";

export default {
  name: "IntergalacticModal",
  components: {
    ModalWrapperChoice
  },
  computed: {
    message() {
      ...
      Becoming intergalactic costs ${format(1e70, 0, 0)} antimatter and requires 4 dimension boosts.`.split("\n");
    },
  },
  methods: {
    handleYesClick() {
...
<template>
  ...
  >
    <template #header>
      You are about to become intergalactic
    </template>
