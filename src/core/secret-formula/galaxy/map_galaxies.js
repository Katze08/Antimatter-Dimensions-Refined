...
export const GALAXY_TYPES = {
  ANTIMATTER_GALAXY: "ANTIMATTER_GALAXY",
  REPLICANTI_GALAXY: "REPLICANTI_GALAXY",
  TACHYON_GALAXY: "TACHYON_GALAXY",
  PELLE_GALAXY: "PELLE_GALAXY",
 ...
 * are specified as numbers which are decoded on-the-fly using positionNumToVector in GalaxyMapTab.vue. The function
